...
public class DAInfo {
    ...
    public void setOtherData(String otherData_) {
        this.otherData_ = otherData_;
    }
    ...
    public Bitmap daInfoBmp()
    {
        ...
        try {
            if(labelType_!=null&&labelType_.equals("PR")) {
                data_ = macid_ + ";" + model_ + ";" + ver_ + ";" + project_ + ";" + power_ + ";" + labelType_ + ";" + date_+";"+id_+otherData_;
                qr = createQRCode(macid_ + ";" + model_ + ";" + ver_ + ";" + project_ + ";" + power_ + ";" + labelType_ + ";" + date_+";"+id_+otherData_, infoPosition_[2]);
            }else
            {
                data_ = macid_ + ";" + model_ + ";" + ver_ + ";" + project_ + ";" + power_ + ";" + labelType_+";"+softwareVer_+";"+id_+otherData_;
                qr = createQRCode(macid_ + ";" + model_ + ";" + ver_ + ";" + project_ + ";" + power_ + ";" + labelType_+";"+softwareVer_+";"+id_+otherData_, infoPosition_[2]);
            }
        }catch (Exception ex){}
        if(qr==null){
            return null;
    ...
    public Bitmap daInfoBmp60x40()
    {
        ...
        infoPosition_[DAInfoPosition.namePositionY]=75;
    ...
    public Bitmap daInfoBmp70x40()
    {
        infoPosition_[DAInfoPosition.bmpWidth]=560;
        infoPosition_[DAInfoPosition.bmpHeight]=320;
        infoPosition_[DAInfoPosition.QRCodeSize]=240;
        infoPosition_[DAInfoPosition.textSize]=32;
        infoPosition_[DAInfoPosition.QRCodePositionX]=325;
        infoPosition_[DAInfoPosition.QRCodePositionY]=10;

        infoPosition_[DAInfoPosition.namePositionX]=40;
        infoPosition_[DAInfoPosition.namePositionY]=75;
        infoPosition_[DAInfoPosition.powerPositionX]=40;
        infoPosition_[DAInfoPosition.powerPositionY]=135;
        infoPosition_[DAInfoPosition.modelPositionX]=40;
        infoPosition_[DAInfoPosition.modelPositionY]=195;
        infoPosition_[DAInfoPosition.macidPositionX]=40;
        infoPosition_[DAInfoPosition.macidPositionY]=255;
    ...
    public Bitmap daInfoBmp40x30(int textSize)
    {
        infoPosition_[DAInfoPosition.bmpWidth]=320;
        infoPosition_[DAInfoPosition.bmpHeight]=240;
        infoPosition_[DAInfoPosition.QRCodeSize]=160;
        infoPosition_[DAInfoPosition.textSize]=textSize;  //20
        infoPosition_[DAInfoPosition.QRCodePositionX]=170;
        infoPosition_[DAInfoPosition.QRCodePositionY]=35;

        infoPosition_[DAInfoPosition.namePositionX]=20;
        infoPosition_[DAInfoPosition.namePositionY]=40;
        infoPosition_[DAInfoPosition.powerPositionX]=20;
        infoPosition_[DAInfoPosition.powerPositionY]=93;
        infoPosition_[DAInfoPosition.modelPositionX]=20;
        infoPosition_[DAInfoPosition.modelPositionY]=146;
        infoPosition_[DAInfoPosition.macidPositionX]=20;
        infoPosition_[DAInfoPosition.macidPositionY]=199;
